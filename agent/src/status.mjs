...
export const HaltReason = Object.freeze({
  ...
  PROFILE_FINGERPRINT_MISMATCH: "PROFILE_FINGERPRINT_MISMATCH",
  PROFILE_TAMPERED: "PROFILE_TAMPERED",
  UNEXPECTED_RESERVATION_SCREEN: "UNEXPECTED_RESERVATION_SCREEN",
  RESERVATION_NOT_ARMED: "RESERVATION_NOT_ARMED",
